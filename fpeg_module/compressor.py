...
def compress(filename, background_quality=10, face_quality=75, show_faces=False):
  ...
  filename_compressed = "output/compressed10.jpg"
  filename_compressed2 = "output/compressed75.jpg"
  ...
  # tmp code: save source w/ higher quality to compare filesize
  cv2.imwrite(filename_compressed2,
              source,
              [cv2.IMWRITE_JPEG_QUALITY, face_quality])
